...
const (
	...
	DO        TokenType = "DO"     // Imperative or procedural action (e.g., DO { ... })
	...
	// modal verbs - future after prolog implementation
	...
	WILL_NEED TokenType = "WILL_NEED" // future
...
var keywords = map[string]TokenType{
	...
	"has":    HAS,
	"do":     DO,
	"how":    HOW,   // ADD THIS LINE
	"when":   WHEN,  // ADD THIS LINE
	"where":  WHERE, // ADD THIS LINE
	"symbol": SYMBOL_KW,
}
